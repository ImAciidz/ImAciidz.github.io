...
Note the only times I saw mission (or maybe it was gamemode) null when it wasn't supposed to was when I was on a survival map that did not actually have survival support (TODO)
